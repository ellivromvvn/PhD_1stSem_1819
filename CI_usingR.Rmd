...
- Introduction to **R**
  1. The **R** Environment
  2. RStudio
  3. Data Type and Objects
  4. Basic Commands
  5. Creating Functions in R
- Confidence Intervals for the Mean (Large Samples)
  1. Finding a Confidence Interval for a Population Mean
- Confidence Intervals for the Mean (Small Samples)
  1. Constructing a Confidence Interval for the Mean: $t$-Distribution
- Confidence Intervals for Population Proportions
  1. Constructing a Confidence Interval for a Population Proportion
  2. Finding a Minimum Sample Size to Estimate $p$
- Confidence Intervals for Variance and Standard Deviation
  1. Constructing a Confidence Interval for a Variance and Standard Deviation
