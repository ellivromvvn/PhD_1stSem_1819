...
Half of the respondents are 21 years old, 25% are 22 years old, one is 24 years old and one is 39 years old. Table 4 is the frequency distribution and summary of age.
...
Among those who took the calculator test, 62.50% failed and 37.50% passed. The mean score is 46.25% which is not even passing. The exam result is not remarkable. Table 5 shows the frequency distribution and summary of calculator test scores.
